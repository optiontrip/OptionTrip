...
const MONTH_ALIASES = Object.freeze([
  [1, ['january', 'jan', 'январь', 'января', 'январе', 'січень', 'січня', 'januar', 'januaru', 'јануар', 'јануару']],
  [2, ['february', 'feb', 'февраль', 'февраля', 'феврале', 'лютий', 'лютого', 'februar', 'februaru', 'фебруар', 'фебруару']],
  [3, ['march', 'mar', 'март', 'марта', 'марте', 'березень', 'березня', 'mart', 'martu', 'март', 'марту']],
  [4, ['april', 'apr', 'апрель', 'апреля', 'апреле', 'квітень', 'квітня', 'april', 'aprilu', 'април', 'априлу']],
  [5, ['may', 'май', 'мая', 'травень', 'травня', 'maj', 'maju', 'мај', 'мају']],
  [6, ['june', 'jun', 'июнь', 'июня', 'июне', 'червень', 'червня', 'jun', 'junu', 'јун', 'јуну']],
  [7, ['july', 'jul', 'июль', 'июля', 'июле', 'липень', 'липня', 'jul', 'julu', 'јул', 'јулу']],
  [8, ['august', 'aug', 'август', 'августа', 'августе', 'серпень', 'серпня', 'avgust', 'avgustu', 'августу']],
  [9, ['september', 'sep', 'sept', 'сентябрь', 'сентября', 'сентябре', 'вересень', 'вересня', 'septembar', 'septembru', 'септембар', 'септембру']],
  [10, ['october', 'oct', 'октябрь', 'октября', 'октябре', 'жовтень', 'жовтня', 'oktobar', 'oktobru', 'октобар', 'октобру']],
  [11, ['november', 'nov', 'ноябрь', 'ноября', 'ноябре', 'листопад', 'листопада', 'novembar', 'novembru', 'новембар', 'новембру']],
  [12, ['december', 'dec', 'декабрь', 'декабря', 'декабре', 'грудень', 'грудня', 'decembar', 'decembru', 'децембар', 'децембру']],
]);
