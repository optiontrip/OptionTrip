...
import { getCheapCountryRoutesByMonth, getCheapRoutePairsByMonth, getCheapRoutesByMonth } from '../controllers/cheapFlightExplorerController.js';
...
router.get('/cheap-country-routes', getCheapCountryRoutesByMonth);
router.get('/cheap-route-pairs', getCheapRoutePairsByMonth);
