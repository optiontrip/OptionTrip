...
const HelpCenterPage = () => {
  ...
  return <>
    ...
    <section style={{padding:'55px 0',background:'#fff'}}><div className="container"><div className="row g-4"><div className="col-lg-4"><div className="p-4 rounded h-100" style={{background:'#e8f0fe'}}><h4>Email Support</h4><p>Questions, account help, partnerships, feedback, or bug reports.</p><a href={CONTACT_MAILTO}>{CONTACT_EMAIL}</a></div></div><div className="col-lg-4"><div className="p-4 rounded h-100" style={{background:'#e8f8f6'}}><h4>Travel Partner Vi</h4><p>Use Vi for travel planning and trip questions inside OptionTrip.</p><Link to="/travel-buddy">Open Vi</Link></div></div><div className="col-lg-4"><div className="p-4 rounded h-100" style={{background:'#fff7e6'}}><h4>Contact Form</h4><p>Send a structured message directly to the OptionTrip team.</p><Link to="/contact">Contact Us</Link></div></div></div></div></section>
